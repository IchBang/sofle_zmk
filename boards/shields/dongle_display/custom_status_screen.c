...
lv_obj_t *zmk_display_status_screen() {
    ...
    // lv_obj_align(zmk_widget_wpm_status_obj(&wpm_status_widget), LV_ALIGN_BOTTOM_RIGHT, 0, -7);
    ...
    // lv_obj_align_to(zmk_widget_layer_status_obj(&layer_status_widget), zmk_widget_wpm_status_obj(&wpm_status_widget), LV_ALIGN_BOTTOM_LEFT, 0, 5);
